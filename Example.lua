...
local URL = "https://cdn.jsdelivr.net/gh/Valox321/Custom-UI@f14bf03bed922c124ca7fb1394f6f8a02b4c62bd/SableLib.lua"
local src = game:HttpGet(URL, true)
print("[sable] bytes:", #src, "| 1.39 drin:", src:find('Version = "1.39"', 1, true) ~= nil)
